...
Ну и в конце примера вы видите, что мы добавляем `false` к пути файла. Именно это говорит Drupal, что файл должен быьь исключен из библиотеки при ее использовании.
...
При замене одной библиотеки на другую, их имена и содержимое не должны соответствовать.

## Заключение

Как я уже говорил ранее, Drupal 8 подошел к вопросу разработки фронт-енда очень основательно и глубоко. Фактически системе предлагает современные инструменты для гибкой и компонент-ориентированной разработки, которых сегодня не дает ни одна из популярных CMS с открытым исходным кодом.

Наша же с вами задача правильно и удачно использовать эти инструменты. Удачи!
